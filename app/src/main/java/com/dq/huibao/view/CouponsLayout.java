...
public class CouponsLayout extends LinearLayout{
    ...
    public CouponsLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            drawType = a.getInt(R.styleable.voucherView_drawType, TRIANGLE);
            mOrientation = a.getInt(R.styleable.voucherView_orientation,DRAW_VERTICAL);//默认水平方向
     ...
     * @param paintColor
     */
    public void setmPaintColor(int paintColor){
