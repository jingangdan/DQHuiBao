...
//
///**
// * Description：拼go购物车（activity）
// * Created by jingang on 2017/11/1.
// */
//public class PinGoShopcarActivity2 extends BaseActivity implements
//        CheckInterface,
...
//        MD5_PATH = "?mid=" + uid + "phone=" + phone + "&timestamp=" + (System.currentTimeMillis() / 1000) + "&token=" + token;
//        PATH = HttpPath.PINGO_CARTLIST + MD5_PATH + "&sign=" +
...
//                PinGoCartList cartList = GsonUtil.gsonIntance().gsonToBean(result, PinGoCartList.class);
//                shopList.clear();
//                shopList.addAll(cartList.getData().getList());
...
//
//                System.out.println("获取购物车 =失败 " + ex.toString());
//            }
//
//            @Override
...
//                }
//
//                intent = new Intent(PinGoShopcarActivity2.this, SubmitOrderActivity.class);
