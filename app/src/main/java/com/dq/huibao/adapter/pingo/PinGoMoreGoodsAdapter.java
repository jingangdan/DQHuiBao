...
public class PinGoMoreGoodsAdapter extends RecyclerView.Adapter<PinGoMoreGoodsAdapter.MyViewHolder>{
    private Context mContext;
    private List<PinGoIndexMoreGoods.DataBean.ListBean> goodsList;
    private OnItemClickListener onItemClickListener;

    public PinGoMoreGoodsAdapter(Context mContext, List<PinGoIndexMoreGoods.DataBean.ListBean> goodsList) {
