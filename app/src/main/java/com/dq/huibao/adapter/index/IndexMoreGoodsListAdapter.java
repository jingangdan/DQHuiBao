...
public class IndexMoreGoodsListAdapter extends RecyclerView.Adapter<IndexMoreGoodsListAdapter.MyViewHolder>{
    private Context mContext;
    private List<IndexMoreGoods.DataBean.ListBean> goodsList;
    private OnItemClickListener onItemClickListener;

    public IndexMoreGoodsListAdapter(Context mContext, List<IndexMoreGoods.DataBean.ListBean> goodsList) {
